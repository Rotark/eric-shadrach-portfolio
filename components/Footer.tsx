      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            >
              <span className="text-teal">E</span>ric <span className="text-teal">S</span>hadrach <span className="text-teal">M</span>iller
            </Link>
            ...
            <ul className="space-y-2">
              {footerLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-foreground-muted hover:text-teal transition-colors text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <div className="flex gap-4">
              {socialLinks.map((link) => (
                <motion.a
                  ...
                  className="p-2 rounded-lg text-foreground-muted hover:text-teal hover:bg-teal/10 transition-all"
        ...
        <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-foreground-muted text-sm">
            © {new Date().getFullYear()} Eric Shadrach Miller. All rights reserved.
          </p>
          <p className="text-foreground-muted text-xs italic">
            &ldquo;From Speculation to Simulation&rdquo;
          </p>
        </div>
      </div>
    </footer>
